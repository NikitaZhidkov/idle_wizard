...
export const CREATURE_TEMPLATES = [
    { id: 'sprite', name: 'Forest Sprite', icon: '🧚', magic: 'CREATURES', hp: 125, atk: 2, gold: 5, spriteIndex: 0 },
    { id: 'beetle', name: 'Venom Beetle', icon: '🪲', magic: 'CREATURES', hp: 150, atk: 3, gold: 8, spriteIndex: 1 },
    { id: 'squid', name: 'Cave Lurker', icon: '🐙', magic: 'DEFENSE', hp: 200, atk: 4, gold: 12, spriteIndex: 2 },
    { id: 'goblin', name: 'Goblin Raider', icon: '👹', magic: 'DARK', hp: 250, atk: 5, gold: 15, spriteIndex: 3 },
    { id: 'ghost', name: 'Restless Spirit', icon: '👻', magic: 'DARK', hp: 275, atk: 5, gold: 18, spriteIndex: 4 },
    { id: 'griffin', name: 'Wild Griffin', icon: '🦅', magic: 'CREATURES', hp: 350, atk: 7, gold: 30, spriteIndex: 5 },
    { id: 'spider', name: 'Giant Spider', icon: '🕷️', magic: 'CREATURES', hp: 425, atk: 9, gold: 40, spriteIndex: 6 },
    { id: 'wraith', name: 'Shadow Wraith', icon: '👤', magic: 'DARK', hp: 500, atk: 11, gold: 60, spriteIndex: 7 },
    { id: 'wolf', name: 'Dire Wolf', icon: '🐺', magic: 'CREATURES', hp: 600, atk: 13, gold: 80, spriteIndex: 8 },
    { id: 'drake', name: 'Fire Drake', icon: '🐉', magic: 'CHARMS', hp: 750, atk: 16, gold: 120, spriteIndex: 9 },
    { id: 'serpent', name: 'Ancient Serpent', icon: '🐍', magic: 'DARK', hp: 900, atk: 18, gold: 150, spriteIndex: 10 }
];

export const BOSS_TEMPLATES = [
    { id: 'troll', name: 'Cave Troll', icon: '🧌', magic: 'CREATURES', hp: 500, atk: 8, gold: 200, boss: true, spriteIndex: 11 },
    { id: 'necromancer', name: 'Necromancer', icon: '💀', magic: 'DARK', hp: 700, atk: 10, gold: 300, boss: true, spriteIndex: 12 },
    { id: 'hydra', name: 'Swamp Hydra', icon: '🐍', magic: 'DEFENSE', hp: 900, atk: 12, gold: 400, boss: true, spriteIndex: 13 },
    { id: 'lich', name: 'The Lich King', icon: '💀👑', magic: 'DARK', hp: 1250, atk: 15, gold: 600, boss: true, spriteIndex: 14 }
];
